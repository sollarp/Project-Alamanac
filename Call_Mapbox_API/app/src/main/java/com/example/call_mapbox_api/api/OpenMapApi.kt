...
interface OpenMapApi {
    @GET("v3/poi/?key=22dcf268-f3e1-4cf4-a152-111d68e9502d/output=json&maxresults=15&compact=true&verbose=false&longitude=-1.360406976465403&latitude=51.954015044041914")
